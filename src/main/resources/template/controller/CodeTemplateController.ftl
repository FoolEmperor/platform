 ...
 * @date ${date}
 */
@Api(tags = "999", description = " ${module}", produces = MediaType.APPLICATION_JSON_VALUE)
@RestController
public class CodeTemplateController {
    ...
    @ApiImplicitParams({
            @ApiImplicitParam(name = CustomConstant.HTTP_HEADERS_SET_COOKIE, value = "token", paramType = "header", required = true, dataType = "java.lang.String", example = "8efdc2eb-0514-4f10-8365-279cdc08707d")
    })
    @ApiResponses({
    ...
    @ApiImplicitParams({
            @ApiImplicitParam(name = CustomConstant.HTTP_HEADERS_SET_COOKIE, value = "token", paramType = "header", required = true, dataType = "java.lang.String", example = "8efdc2eb-0514-4f10-8365-279cdc08707d"),
            @ApiImplicitParam(name = "id", value = "id", paramType = "path", required = true, dataType = "java.lang.String", example = "123456789")
    })
    @ApiResponses({
            @ApiResponse(code = 200, message = "请求成功data值")
    })
